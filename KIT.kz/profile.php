...
<head>
    ...
    <?php
        ...
        if($_GET['u_id'] != $cur_id) {
            //echo "<script>alert('ERROR id #2')</script>";
            echo "<script>window.open('user_profile.php?u_id=$tmp_u_id', '_self')</script>";
            exit();
        }
    ?>
        ...
        <div class="site_content">
            ...
            <div class="content">
                    ...
                    <?php
                        ...
                        <div class='profile_image_section'> 
                            ...
                            <div class='profile_image'>
                                ...
                                <img src='users/$user_image' id='blah' alt='your image'>
                                
                            </div>
                                    <label class='update_photo btn_up'>Select photo
                                        <input type='file' accept='image/*' name='u_ava' hidden='hidden'/>
                                    </label>
                                    <button id='button_profile' class='update_photo' name='update_ava'>&#8635; Update photo</button>
                            </form>

                            <a href='edit_profile.php?u_id=$user_id'> <div class='update_photo'>&#128736; Edit account</div></a>
                            <a href='logout.php'> <div class='update_photo'>&#8618; Log out</div></a>
                        </div>
                        "; 
                        if(isset($_POST["update_ava"])) {
                            $u_ava = $_FILES['u_ava']['name'];
                            $img_tmp = $_FILES['u_ava']['tmp_name'];
                            ...
                            if($u_ava == '') {
                                ...
                                move_uploaded_file($img_tmp, "users/$u_ava.$random_number");
                                $update = "update users set user_image='$u_ava.$random_number' where user_id='$user_id'";

                                $run = mysqli_query($con, $update);
                                if($run) {
                                    echo "<script>alert('Your profile image successfully updated. ')</script>";
                                    echo "<script>window.open('profile.php?u_id=$user_id', '_self')</script>";
                                }
                            }
                        }
                ...
                foreach ($posts as $post) {
                    ...
                    if($content == '' && strlen($upload_image) >= 1) {
                        ...
                        <div class='post_container'>
                            ...
                            <div class='comment_btn'>
                                <a href='functions/delete_post.php?post_id=$post_id'><button> <img src='assets/img/trash2.svg' class='svg_img_btn'> </button></a>
                            </div>
                        ...
                        <div class='post_container'>
                            ...
                            <div class='comment_btn'>
                                <a href='edit_post.php?post_id=$post_id' title='Edit'><button> <img src='assets/img/edit.svg' class='svg_img_btn'> </button></a>
                            </div>
                        </div>
                ...
                while ($row_posts = mysqli_fetch_array($run_posts)) {
                    ...
                    //Display the posts to profile page
                    ...
                    if($content == '' && strlen($upload_image) >= 1) {
                        ...
                        if($u_email != $user_email) {
                            echo "<script>alert('hahah, you are a good hacker :D')</script>";
                            echo "<script>window.open('profile.php?u_id=$user_id', '_self')</script>";
                        }
                        else {
                            echo "
